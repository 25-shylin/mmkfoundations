...
<?php 
    ...
    $selectemployeequerycount = "select * from employee";
      ...
      $employeequery = "insert into employee(employeeno, staffname, fathername, dob, gender, city, state, pincode, address, mobileno, email, workknowledge, workingexperience, dateofjoining, salarydetails, accountsdetails, dayreport, password, degree, nameofdegree, tenthcertification, twelfthcertificate, ugdegreecertificate, pgdegreecertificate, experiencecertificate, aadhaarcard, pancard, staffimg)values('$employeeno', '$staffname', '$fathername', '$dob', '$gender', '$city', '$state', '$pincode', '$address', '$mobileno', '$email', '$workknowledge', '$workingexperience', '$dateofjoining', '$salarydetails', '$accountsdetails', '$dayreport', '$password', '$degree', '$nameofdegree', '$tenthcertification', '$twelfthcertificate', '$ugdegreecertificate', '$pgdegreecertificate', '$experiencecertificate', '$aadhaarcard', '$pancard', '$staffimg')";
       
       if ($staffname == '') {
        echo "<script>alert('please enter staffname')</script>";
       }else
          {
