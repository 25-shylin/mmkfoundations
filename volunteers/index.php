            ...
            <div class="row">
                <div class="login-bg">
                    ...
                    <div class="login-left">
                        ...
                        <h1 style="color: #fff;">Volunteers</h1>
                    ...
                    <form action="#" method="post">
                        <div class="login-form-body">
                            <div class="form-gp">
                                ...
                                <input type="text" id="exampleInputEmail1" name="volunteersindividualsno" autocomplete="off">
                                <i class="ti-email"></i>
                            </div>
                            <div class="form-gp">
...
<?php 
 // login
    if (isset($_POST['login'])) {
        $username = mysqli_real_escape_string($con, $_POST['volunteersindividualsno']);
        $password = mysqli_real_escape_string($con, $_POST['password']);
        $encrypt = md5($password);
      
      

      $volunteersquery = "select * from volunteersindividuals where volunteersindividualsno = '$username' AND password = '$password'";
