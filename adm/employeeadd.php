        ...
        <div class="main-content-inner">
            <div class="row">
                ...
                <div class="col-12 mt-4">
                    <div class="card">
                        <div class="card-body">
                          <center><h4 class="header-title" style="margin-top: 20px;margin-bottom:20px;">Employee Add Details</h4></center>
                            <div class="table-responsive datatable-primary">
                                <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-5">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="typeofacc" name="typeofacc">
                                            </div>
                                            <div class="form-group">
                                    ...
                                    <hr>
                                    <center>
                                        <h4 style="margin-top: 20px;margin-bottom:20px;">Documents</h4>
                                    </center>
                                    <div class="row">
                                        ...
                                        <div class="col-md-5">
                                            ...
                                            <div class="form-group">
                                             ...
                                             <a href="http://localhost/mmkfoundation/adm/employee.php"><input type="button"  class="btn btn-primary pull-right" value="Back" style="width: 100px;margin-right:10px;"></a>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                        </div>
...
if (isset($_POST['submit'])) {
    ...
    $employeequery = "insert into employee(employeeno, staffdesignation, staffname, fathername, dob, gender, city, state, pincode, address, mobileno, email, workknowledge, workingexperience, dateofjoining, salarydetails, accountsdetails, dayreport, password, degree, nameofdegree, tenthcertification, twelfthcertificate, ugdegreecertificate, pgdegreecertificate, experiencecertificate, aadhaarcard, pancard, staffimg,bankname,typeofacc,accnum,ifsc,branch)values('$employeeno', '$staffdesignation', '$staffname', '$fathername', '$dob', '$gender', '$city', '$state', '$pincode', '$address', '$mobileno', '$email', '$workknowledge', '$workingexperience', '$dateofjoining', '$salarydetails', '$accountsdetails', '$dayreport', '$password', '$degree', '$nameofdegree', '$tenthcertification', '$twelfthcertificate', '$ugdegreecertificate', '$pgdegreecertificate', '$experiencecertificate', '$aadhaarcard', '$pancard', '$staffimg','$bankname','$typeofacc','$accnum','$ifsc','$branch')";
