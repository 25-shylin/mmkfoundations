<?php 
  ...
  //volunteers
//volunteers induviduals

if (isset($_GET['volunteersindividualsid'])) {
  $volunteersindividualsid = $_GET['volunteersindividualsid'];
  $deletequeryvolunteers = "delete from volunteersindividuals where volunteersindividualsid = '$volunteersindividualsid'";
  if (mysqli_query($con,$deletequeryvolunteers)) {
    echo "<script>alert('volunteers has been deleted')</script>";
    echo "<script>window.open('../volunteers.php', '_self')</script>";
  }
