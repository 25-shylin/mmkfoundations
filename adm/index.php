...
<head>
    ...
    *===========================-->
    ...
    <!--=========================*
              Page Title
    *===========================-->
    <title>Admin | MMK FOUNDATION</title>
                    ...
                    <form action="#" method="post">
                        <div class="login-form-body">
                            <div class="form-gp">
                                ...
                                <input type="text" id="exampleInputEmail1" name="admin_name">
                                <i class="ti-email"></i>
                            </div>
                            <div class="form-gp">
                                <label for="exampleInputPassword1">Password</label>
                                <input type="password" id="exampleInputPassword1" name="admin_password">
                                <i class="ti-lock"></i>
                            </div>
...
<?php 
 // login
    if (isset($_POST['login'])) {
      ...
      $admin_query = "select * from admin where admin_name = '$admin_name' AND admin_password = '$admin_password'";
