...
session_start();
 if (!isset($_SESSION['username'])) {
    ...
    if (isset($_GET['employeesedit'])) {
    $page_id = $_GET['employeesedit'];
      $selectemployeequery = "select * from employees where employeesid='$page_id'";
                            ...
                            <div class="table-responsive datatable-primary">
                                ...
                                <div class="card-box">
                                  <h4 class="header-title m-t-0 m-b-30">Member Details</h4>
                                    <form method="post" action="employeesedit.php?volunteersindividualsid=<?= $volunteersindividualsid; ?>" enctype="multipart/form-data">
