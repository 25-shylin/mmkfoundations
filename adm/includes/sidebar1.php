            ...
            <div id="sidebar-menu">
                ...
                *===========================-->
                <ul class="metismenu" id="sidebar_menu">
                    ...
                    <li class="menu-title">Volunteers Master</li>
                    <li>
                        <a href="index.html">
                    ...
                    <li class="menu-title">Staff Master</li>
                    <li>
                        <a href="index.html">
                    ...
                    <li class="menu-title">Event Master</li>
                    <li>
                        <a href="index.html">
                    ...
                    <li class="menu-title">Account Master</li>
                    <li>
                        <a href="index.html">
                    ...
                    <li class="menu-title">Rise Managemnt Master</li>
                    <li>
                        <a href="index.html">
                            <i class="fa fa-tasks"></i>
                            <span>Rise Managemnt</span>
                        </a>
                    </li>
