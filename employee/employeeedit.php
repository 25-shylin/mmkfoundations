                                         ...
                                         <div class="row">   
                                                ...
                                                <div class="col-md-6">
                                                        ...
                                                        <div class="form-group" hidden>
                                                            <label for="employeeno">Employee No</label>
                                                            <input type="text" class="form-control" id="employeeno"  name="employeeno" value="<?= $employeeno ?>" >
                                                        </div>
                                                        <div class="form-group">
