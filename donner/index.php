...
<head>
    ...
    *===========================-->
    ...
    <meta name="description" content="Doneer | MMK FOUNDATION">

    <!--=========================*
              Page Title
    *===========================-->
    <title>Doneer | MMK FOUNDATION</title>
                    ...
                    <form action="#" method="post">
                        <div class="login-form-body">
                            <div class="form-gp">
                                ...
                                <input type="text" id="exampleInputEmail1" name="donaterno" autocomplete="off">
                                <i class="ti-email"></i>
                            </div>
                            <div class="form-gp">
...
<?php 
 // login
    if (isset($_POST['login'])) {
        $username = mysqli_real_escape_string($con, $_POST['donaterno']);
        $password = mysqli_real_escape_string($con, $_POST['password']);
        $encrypt = md5($password);
      
      

      $volunteersquery = "select * from donater where donaterno = '$username' AND password = '$password'";
