                                         ...
                                         <div class="row">   
                                                ...
                                                <div class="col-md-6">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" id="eventsdescription" name="eventsdescription">
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" id="eventpartnerdescription" name="eventpartnerdescription">
                                                        </div>
